...
local themes_path = string.format("%s/.config/awesome/themes/gruvbox-light/", os.getenv("HOME"))
...
theme.bg_normal     = "#f9f5d7"
theme.bg_focus      = "#fbf1c7"
theme.bg_minimize   = "#ebdbb2"
theme.bg_urgent     = "#a89984"
theme.bg_systray    = "#d5c4a1"
...
theme.wallpaper = themes_path.."gruvbox.png"
