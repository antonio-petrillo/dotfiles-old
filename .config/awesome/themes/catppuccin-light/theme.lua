...
local themes_path = string.format("%s/.config/awesome/themes/catppuccin-light/", os.getenv("HOME"))
...
theme.bg_focus      = theme.rosewater
theme.bg_minimize   = theme.rosewater
theme.bg_urgent     = theme.peach
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = theme.black_0
theme.fg_focus      = theme.black_0
theme.fg_urgent     = theme.red
theme.fg_minimize   = theme.black_3

theme.useless_gap   = dpi(5)
theme.border_width  = dpi(3)
theme.border_normal = theme.rosewater
...
theme.wallpaper = themes_path.."plum-blossoms.jpg"
